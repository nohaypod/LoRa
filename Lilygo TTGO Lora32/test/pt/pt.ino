...
void setup() {
  ...
  display.print("ID:");
  int x=0, y=10, level=0;
  display.drawRect(x, y, 30, 15, SSD1306_WHITE);
  
  // Dibujar el terminal positivo de la batería
  display.fillRect(x + 30, y + 4, 2, 7, SSD1306_WHITE);

  // Dibujar el nivel de carga
  int fillWidth = (level * 28) / 100; // Calcular el ancho del nivel de carga
  display.fillRect(x + 1, y + 1, fillWidth, 13, SSD1306_WHITE);
