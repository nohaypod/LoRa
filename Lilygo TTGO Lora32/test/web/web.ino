...
void onMessage(uint8_t *buffer, size_t size)
{
  ...
  LoRaNow.clear();
  LoRaNow.print("LoRa Gateway mensagem de confirmación ");
  LoRaNow.print(millis());
  LoRaNow.send();

  //en pantalla
  byte count = LoRaNow.count();
  display.clearDisplay();  // Limpiar la pantalla antes de mostrar un nuevo mensaje
